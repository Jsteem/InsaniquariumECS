...
public class ImageInfo {
    ...
    public enum IMAGE_NAME{
        ...
        BACKGROUND_TANK0,
        BACKGROUND_TANK5,
        SMALL_SWIM_STAR, SMALL_EAT_STAR, SMALL_TURN_STAR, SMALL_DIE_STAR, HUNGRY_SWIM_STAR, HUNGRY_EAT_STAR, HUNGRY_TURN_STAR, PEARL,
        STINKY, NIKO, ZORF, PREGO, VERT, CLYDE, MERYL,
