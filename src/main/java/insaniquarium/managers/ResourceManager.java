...
public class ResourceManager {
    ...
    public void loadImageInfo(){
        ...
        nameToInfo.put(ImageInfo.IMAGE_NAME.BACKGROUND_TANK1, new ImageInfo("aquarium1.gif", -1,-1,-1,-1));
        nameToInfo.put(ImageInfo.IMAGE_NAME.BACKGROUND_TANK2, new ImageInfo("aquarium2.gif", -1,-1,-1,-1));
        nameToInfo.put(ImageInfo.IMAGE_NAME.BACKGROUND_TANK3, new ImageInfo("aquarium3.gif", -1,-1,-1,-1));
        nameToInfo.put(ImageInfo.IMAGE_NAME.BACKGROUND_TANK4, new ImageInfo("aquarium4.gif", -1,-1,-1,-1));
